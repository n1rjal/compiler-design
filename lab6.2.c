...
// Function to compute FOLLOW of a grammar symbol
void follow(char* Result, char c) {
    int k;
    subResult[0] = '\0';
    Result[0] = '\0';
...
// Function to compute FIRST of a grammar symbol
...
// Function to add symbols to the result set without repetition
